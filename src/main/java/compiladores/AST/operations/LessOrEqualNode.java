...
public class LessOrEqualNode extends ExpresionNode {
    private ExpresionNode left;
    private ExpresionNode right;

    public LessOrEqualNode(String value, ExpresionNode left, ExpresionNode right) {
        super(NodeType.LessEqualNode, value);
        this.left = left;
        this.right = right;
    }
